 ...
 */
require(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'ojs/ojbutton', 'ojs/ojtoolbar','ojs/ojmenu','ojs/ojcollapsible',
    'ojs/ojmodule','ojs/ojrouter','ojs/ojnavigationlist'], // add additional JET component modules as needed
  function(oj, ko, $) // this callback gets executed when all required modules are loaded
  {
      ...
      function IndexPageViewModel(){
          var self=this;
           ...
           self.appName = ko.observable("CLs");
           //states,defaultSateId,stateId
